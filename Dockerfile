...
RUN  apt-get install -y atop nload iftop wget strace mc vim tmux mlocate man-db iotop zip tar unzip curl gnupg procps-ng hostname net-tools nmap tcpdump telnet traceroute mtr nginx nmap rsync ftp jq git elinks 
